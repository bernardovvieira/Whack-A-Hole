...
public class Mole : MonoBehaviour {
    [Header("Gr�ficos")]
    [SerializeField] private Sprite mole;              // Sprite do mole padr�o
    ...
    private int moleIndex = 0;      // �ndice �nico do mole
    ...
    // Ajusta o n�vel do mole (dificuldade)
